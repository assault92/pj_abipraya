...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('admin/assets/datatables-bootstrap/jquery.dataTables.css'); ?>" />
  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
  		...
  		<div class="tulisan">
  			<h2 class="judul">PEKAN OLAHRAGA NASIONAL XIX</h2>
  		</div>      
        <div class="navbar-collapse collapse navbar-right">
          <ul class="nav navbar-nav">
          	<li class="<?php echo strpos(current_url(), base_url('index.php/public/cabor')) !== false ? 'active' : '';?>"><a href="<?php echo base_url('index.php/public/cabor'); ?>">CABOR</a></li>
            <li class="<?php echo strpos(current_url(), base_url('index.php/public/wilayah')) !== false ? 'active' : '';?>"><a href="<?php echo base_url('index.php/public/wilayah'); ?>">WILAYAH</a></li>
          </ul>
        </div><!--/.nav-collapse -->
	...
	<script src="<?php echo base_url('admin/assets/datatables-bootstrap/dataTables.bootstrap.js'); ?>"></script>
    <script src="<?php echo base_url('admin/assets/datatables-bootstrap/jquery.dataTables.js'); ?>"></script>
	<script>
      $(function () {
        $('#maintable').DataTable({
          "paging": true,
