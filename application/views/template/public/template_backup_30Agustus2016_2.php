    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <!-- <img src="<?php //echo base_url('admin/images/logopon.png'); ?>" width="40" height="40" class="user-image" alt="User Image"> -->
          ...
          <a class="navbar-brand" href="index.html">PEKAN OLAHRAGA NASIONAL XIX JAWA BARAT</a>
        </div>
