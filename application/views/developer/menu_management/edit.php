...
<fieldset id="fieldset_menu_editor">
	...
	<form action="<?php echo base_url('index.php/developer/menu_management/edit/' . $this->group->name . '/' . $data->id); ?>" method="post">
		<ul style="list-style:none;">
			...
			<li>
				...
				<?php foreach($$field->result() as $item): ?>
					<option value="<?php echo $item->controller; ?>" <?php echo set_value($field, $data->$field) == $item->controller ? 'selected' : ''; ?>><?php echo $item->controller; ?></option>
				<?php endforeach; ?>
				</select>
			</li>
